...
<div class="col-md-6 col-lg-6 col-md-offset-3  col-lg-offset-3">
    ...
    <div class="panel-heading">All Companies <a  class="btn btn-primary btn-sm" href="/companies/create">
    @elseif(\Request::is('companies'))
    <div class="panel-heading">My Companies <a  class="btn btn-primary btn-sm" href="/companies/create">
    @endif
